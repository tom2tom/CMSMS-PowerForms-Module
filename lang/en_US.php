...
$lang['error_emailfromfeuprop'] = '<span style="color:red">Error</span>';
$lang['error_nofeu'] = 'The FrontEndUsers module could not be found. This field will not function.';
$lang['error_nofeudefns'] = 'No dropdown, multiselect or radiobutton FEU property found. This field will not function.';
...
$lang['title_show_fieldaliases_long']='Display field aliases when adding or editing a form';
...
$lang['title_hide_label_long']='Don\'t show this field\'s name on the form';
...
$lang['title_enable_antispam_long']='Limit to 10 emails per hour from the given IP address';
$lang['title_enable_antispam']='Enable primitive anti-spam features';
$lang['title_show_fieldids'] = 'Show field IDs';
$lang['title_show_fieldids_long'] = 'Display field ID numbers when adding or editing a form';
...
$lang['title_default_blank_help']='If un-checked, default to today\'s date';
...
$lang['help_variables_for_template']='Template variables';
...
$lang['']='Alternate field names can be used interchangeably (especially useful if Smarty is choking on characters outside of ASCII 32-126).';
...
$lang['title_default_year_help'] = 'Use -1 for the current year';
...
$lang['title_submit_response_help'] = 'This template is for display to the user after the form is submitted, and doesn\'t affect form dispositions, such as generated emails. Disposition-specific templates are (where appropriate) set in the "advanced" tab for the disposition field.';
...
$lang['title_unique_fieldnames_long'] = 'Require each field to have a unique name';
...
$lang['title_must_save_order'] = 'You must click one of the "save" buttons to make the new field order permanent.';
...
$lang['desc_in_formbrowser'] = '1 if form is being viewed from FormBrowser';
$lang['desc_in_admin'] = '1 if form is being viewed via FormBrowser admin';
$lang['desc_fbr_id'] = 'Response ID if form is being viewed from FormBrowser';
$lang['desc_fb_hidden'] = 'Collection of necessary hidden stuff';
...
$lang['globals_help1']='To make the form work, you\'ll need to always include the {$fb_hidden} and {$submit} tags.<br />
Dunno why you\'d want some of the others, but there you go...';
$lang['attrs_help1']='You can access form fields either using the {$fields} array or by directly accessing
fields by their names (e.g. {$myfield->input)<br /><br />Each field has the following attributes:';
$lang['attrs_help2']='In some cases, field->input is actually an array of objects rather than an input. This
 happens, for example, in CheckBoxGroups or RadioButtonGroups. For them, you can iterate
 through field->input->name and field->input->input and field->input->op.<br /><br />
For a multi-page form, you can access the value of previous fields. They are in the
 {$previous} array, or accessible by their names (e.g. {$myfield->value}). You
...
write your CSS.</p>
<p>More detailed advice is provided on the \"Form Template\" tab shown when a form is being edited.</p>
<ul>
<li>Standard Inputs
...
<li>*Write Each Submission to a Unique Flat File. This takes the form results and writes them to a unique text file for each form submission.
