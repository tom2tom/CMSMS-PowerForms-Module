...
$lang['confirm_template'] = 'Are you sure you want to overwrite the current template? (Even if you select OK, you will still need to save the change)';
...
$lang['title_form_next_button'] = '"Next" button label (used for multipage forms)';
...
$lang['title_form_prev_button'] = '"Previous" button label (used for multipage forms)';
