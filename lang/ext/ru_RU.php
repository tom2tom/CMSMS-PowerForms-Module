...
$lang['field_type_CatalogerItemsField'] = 'Выберите одну или более позицию из каталога';
$lang['field_type_FieldsetEnd'] = 'Конец группы полей (fieldset)';
$lang['field_type_FieldsetStart'] = 'Начало группы полей (fieldset)';
$lang['field_type_TextField'] = 'Текстовое поле (input)';
$lang['field_type_HTML5NumberField'] = 'HTML5 числовое поле ввода';
$lang['field_type_HTML5EmailField'] = 'HTML5 поле ввода Email';
$lang['field_type_HTML5URLField'] = 'HTML5 поле ввода URL';
$lang['field_type_PasswordField'] = 'Пароль';
$lang['field_type_PasswordAgainField'] = 'Пароль снова (проверка)';
$lang['field_type_TextFieldExpandable'] = 'Текстовое поле (несколько штук)';
$lang['field_type_TextAreaField'] = 'Текстовое окно (textarea)';
$lang['field_type_ButtonField'] = 'Кнопка';
$lang['field_type_CheckboxField'] = 'Галочка (checkbox)';
$lang['field_type_CheckboxGroupField'] = 'Несколько галочек (checkbox group)';
$lang['field_type_PulldownField'] = 'Выпадающий список';
$lang['field_type_YearPullDownField'] = 'Year Pulldown';
$lang['field_type_MultiselectField'] = 'Множественный выбор';
$lang['field_type_StatePickerField'] = 'Выбор штатов США';
$lang['field_type_ProvincePickerField'] = 'Выбор канадской провинции';
$lang['field_type_CountryPickerField'] = 'Выбор страны';
$lang['field_type_DatePickerField'] = 'Выбор даты';
$lang['field_type_TimePickerField'] = 'Выбор времени';
$lang['field_type_RadioGroupField'] = 'Группа радиокнопок';
...
$lang['field_type_DispositionEmail'] = '*Отправить результат на указанные e-mail адреса';
$lang['field_type_DispositionEmailConfirmation'] = '*Проверка-через-Email адрес';
$lang['field_type_DispositionFromEmailAddressField'] = '*Поле Email "От кого(адрес)", и отправить копию';
$lang['field_type_DispositionFile'] = '*Записать результаты в файл';
$lang['field_type_DispositionUniqueFile'] = '*Write Results to a Unique Flat File for each submission';
$lang['field_type_DispositionDatabase'] = '*Записать результаты в базу данных';
$lang['field_type_DispositionFormBrowser'] = '*Записать результаты в формате FormBrowser Module v.3';
$lang['field_type_DispositionUserTag'] = '*Вызвать тег пользователя с результатами формы в качестве параметров';
$lang['field_type_DispositionForm'] = '*Submit to an arbitrary form action';
$lang['field_type_DispositionDeliverToEmailAddressField'] = '*Отправить по адресу, указанному пользователем';
$lang['field_type_DispositionEmailSiteAdmin'] = '*Отправить администратору CMS';
$lang['field_type_DispositionEmailBasedFrontendFields'] = '*Email results based on frontend fields';
$lang['field_type_PageBreakField'] = '-Разрыв страницы';
$lang['field_type_FileUploadField'] = 'Загрузка файла';
$lang['field_type_FromEmailAddressField'] = 'Почтовое поле "E-mail отправителя"';
$lang['field_type_FromEmailAddressAgainField'] = 'Почтовое поле "E-mail отправителя" - повтор';
$lang['field_type_FromEmailNameField'] = 'Почтовое поле "Имя отправителя"';
$lang['field_type_FromEmailSubjectField'] = 'Почтовое поле "Тема"';
$lang['field_type_StaticTextField'] = '-Статический текст';
$lang['field_type_SystemLinkField'] = '-Статическая ссылка';
$lang['field_type_LinkField'] = 'Ссылка (пользователя)';
$lang['field_type_HiddenField'] = '-Скрытое поле';
$lang['field_type_ComputedField'] = '-Вычисленное поле';
$lang['field_type_UniqueIntegerField'] = '-Не повторяющееся целое число (serial)';
...
$lang['validation_none'] = 'Нет проверки';
$lang['validation_numeric'] = 'Число';
$lang['validation_integer'] = 'Целое число';
$lang['validation_email_address'] = 'Адрес e-mail';
$lang['validation_usphone'] = 'Номер телефона (США)';
$lang['validation_must_check'] = 'Должна быть проставлена галочка';
$lang['validation_regex_match'] = 'Должно подходить под регулярное выражение';
$lang['validation_regex_nomatch'] = 'Не должно подходить под регулярное выражение';
$lang['required_field_missing'] = 'Обязательное поле формы не было заполнено';
$lang['please_enter_a_value'] = 'Пожалуйста, заполните поле "%s"';
$lang['please_enter_a_number'] = 'Пожалуйста, введите число для поля "%s"';
$lang['please_enter_valid'] = 'Пожалуйста, корректно заполните поле "%s"';
$lang['please_enter_an_integer'] = 'Пожалуйста, введите целое число для поля "%s"';
$lang['please_enter_an_email'] = 'Введите корректный e-mail адрес в поле "%s"';
$lang['email_address_does_not_match'] = 'Введенный e-mail адрес не совпадает с полем "%s"';
$lang['please_enter_a_phone'] = 'Пожалуйста, введите в поле "%s" корректный номер телефона';
$lang['please_login'] = 'Пожалуйста, войдите, чтобы использовать эту форму';
$lang['not_valid_email'] = 'Адрес, введенный в поле "%s" не является корректным e-mail адресом!';
$lang['please_enter_no_longer'] = 'Пожалуйста, введите значение не превышающее %s символов';
$lang['please_enter_at_least'] = 'Пожалуйста, введите значение, по крайней мере %s символов';
$lang['title_list_delimiter'] = 'Символ для использования в качестве разделителя в результатах, когда возвращается более одного значения';
$lang['you_need_permission'] = 'Вам нужны права "%s", чтобы выполнить это действие.';
$lang['lackpermission'] = 'Извините, но у вас нет прав доступа к этой части сайта.';
$lang['field_order_updated'] = 'Порядок полей обновлен.';
$lang['form_deleted'] = 'Форма удалена.';
$lang['field_deleted'] = 'Поле удалено.';
$lang['configuration_updated'] = 'Конфигурация обновлена.';
$lang['you_must_check'] = 'Вы должны проверить "%s", чтобы продолжить.';
$lang['must_specify_one_destination'] = 'Вам необходимо указать как минимум один адрес назначения!';
$lang['are_you_sure_delete_form'] = 'Вы уверены, что хотите удалить форму %s?';
$lang['are_you_sure_delete_field'] = 'Вы уверены, что хотите удалить поле %s?';
$lang['notice_select_type'] = 'Пока не указан тип поля, дополнительные настройки не отображаются.';
...
$lang['field_no_name'] = 'Каждому полю должно быть присвоено имя, если только это не отключено в настройках Конструктора форм.';
$lang['no_field_assigned'] = 'Нет поля предназначенного для %s';
$lang['anonymous'] = 'Анонимно';
$lang['abbreviation_length'] = 'Длина: %s';
$lang['boxes'] = '%s boxes';
$lang['options'] = '%s опций';
$lang['text_length'] = '%s символов.';
$lang['order'] = 'Порядок';
$lang['unspecified'] = '[не указано]';
$lang['added'] = 'добавлено';
$lang['updated'] = 'обновлено';
$lang['sort_options'] = 'Сортировать настройки при выводе';
$lang['select_one'] = 'Выберите один из предлагаемых вариантов';
...
$lang['fields'] = 'поля';
$lang['file_count'] = '%s возможных файлов';
$lang['destination_count'] = '%s направлений';
$lang['save'] = 'Сохранить';
$lang['add'] = 'Добавить';
$lang['update'] = 'Обновить';
$lang['save_and_continue'] = 'Сохранить и продолжить редактирование';
$lang['information'] = 'Информация';
$lang['automatic'] = 'Автоматически';
$lang['forms'] = 'Формы';
$lang['form'] = 'Форма "%s"';
$lang['configuration'] = 'Конфигурация';
$lang['field_requirement_updated'] = 'Обязательное поле, состояние обновлено.';
$lang['maximum_size'] = 'Макс. размер';
$lang['permitted_extensions'] = 'Расширения';
$lang['permitted_filetypes'] = 'Разрешенные типы файлов';
$lang['file_too_large'] = 'Закачанный файл слишком велик! Максимальный допустимый размер:';
$lang['illegal_file_type'] = 'Закачка файлов этого типа запрещена. Пожалуйста, проверьте, что дали файлу корректное расширение.';
$lang['upload'] = 'Закачать';
$lang['form_imported'] = 'Форма импортирована.';
$lang['form_import_failed'] = 'Форма не была импортирована! Формат XML-файла некорректный.';
$lang['rows'] = '%s строк';
$lang['cols'] = '%s колонок';
$lang['12_hour'] = '12-часовые часы';
$lang['24_hour'] = '24-часовые часы';
$lang['hour'] = 'Час';
$lang['min'] = 'Минута';
$lang['merid'] = 'Меридиан';
$lang['date_range'] = 'Интервал: %s - %s';
$lang['thanks'] = 'Спасибо! Ваш запрос был получен.';
...
$lang['button_previous'] = 'Назад...';
$lang['button_submit'] = 'Отправить';
$lang['button_continue'] = 'Далее...';
$lang['value_checked'] = 'Проставлена галочка';
$lang['value_unchecked'] = 'Не проставлена галочка';
$lang['tab_main'] = 'Основные настройки';
$lang['tab_symbol'] = 'Настройки отображения формы';
$lang['tab_submit'] = 'Настройки отправки формы';
$lang['tab_captcha'] = 'Настройки Captcha';
$lang['tab_advanced'] = 'Дополнительные настройки';
$lang['tab_templatelayout'] = 'Шаблон формы';
$lang['tab_submissiontemplate'] = 'Шаблон отправки формы';
$lang['tab_udt'] = 'UDT интеграция';
$lang['canuse_smarty'] = '<em>В этом поле можно использовать переменные Smarty.</em>';
$lang['add_options'] = 'Добавить ещё опций';
$lang['delete_options'] = 'Удалить отмеченные опции';
$lang['add_checkboxes'] = 'Добавить ещё галочек';
$lang['delete_checkboxes'] = 'Удалить отмеченные галочки';
$lang['add_address'] = 'Добавить другой адрес';
$lang['delete_address'] = 'Удалить отмеченные адреса';
$lang['add_destination'] = 'Добавить другое назначение';
$lang['delete_destination'] = 'Удалить помеченные назначения';
$lang['suspected_spam'] = 'С Вашего IP-адреса поступает слишком много запросов. Система защиты от спама заблокировала отправку формы.';
$lang['suspected_spam_log'] = 'Предполагаемый спам с IP-адреса %s остановлен.';
$lang['reorder'] = 'Поменять порядок полей';
$lang['cancel'] = 'Отмена';
$lang['value_set'] = 'Указанное значение: %s';
...
<br/>';
$lang['help_name_regex'] = 'Регулярное выражение позволяет фильтровать элементы каталога по имени';
$lang['help_field_height'] = 'Высота множественного поля';
$lang['title_name_regex'] = 'Cataloger Item Name Regular Expression';
$lang['title_field_height'] = 'Высота поля';
$lang['title_file_path'] = 'Целевой каталог для выходных файлов';
$lang['title_udt_name'] = 'Тег пользователя';
$lang['title_uploads_destpage'] = 'Page to return to with uploads link';
$lang['title_uploadmodule_summary'] = 'Отправлено formbuilder';
$lang['title_uploads_category'] = 'Категория загрузок';
$lang['title_sendto_uploads'] = 'Отправить этот файл в модуль загрузок';
$lang['title_allow_overwrite'] = 'Разрешить загружать на перезапись ранние файлы?';
$lang['title_allow_overwrite_long'] = 'Загружаемый файл перезаписывает ранее загруженный файл, если он имеет тоже имя?';
$lang['overwrite'] = 'Позволить перезапись';
$lang['nooverwrite'] = 'Запретить перезапись';
$lang['file_already_exists'] = 'Файл %s уже существует, и не может быть перезаписан.';
$lang['title_file_rename'] = 'Шаблон имени файла';
$lang['original_file_extension'] = 'Оригинальное расширение файла (включая ".")';
...
$lang['title_legend'] = 'Легенда';
$lang['title_maximum_length'] = 'Максимальная длина';
$lang['title_checkbox_label'] = 'Подпись елемента Checkbox (галочка)';
$lang['title_radio_label'] = 'Подпись елемента Radio Button (радио кнопка)';
$lang['title_checked_value'] = 'Значение когда проставлена галочка';
$lang['title_unchecked_value'] = 'Значение когда нет галочки';
$lang['title_checkbox_details'] = 'Checkbox Group Details';
$lang['title_delete'] = 'Удалить?';
$lang['title_select_one_message'] = '"Select One" Text';
$lang['title_selection_value'] = 'Выбор значения';
$lang['title_selection_displayname'] = 'Selection Display Name';
$lang['title_selection_subject'] = 'Выбор темы';
$lang['title_select_default_country'] = 'Выбор по умолчанию';
$lang['title_select_default_state'] = 'Выбор по умолчанию';
$lang['title_select_default_province'] = 'Выбор по умолчанию';
$lang['title_option_name'] = 'Option Name';
$lang['title_option_value'] = 'Значение отправлено';
$lang['title_pulldown_details'] = 'Pulldown Options';
$lang['title_multiselect_details'] = 'Multiselect Options';
$lang['title_destination_address'] = 'Назначенный почтовый адрес';
$lang['title_destination_filename'] = 'Назначенное имя файла';
$lang['title_email_from_name'] = '"От кого" для email';
$lang['title_relaxed_email_regex'] = 'Использовать слабую проверку email';
$lang['title_relaxed_regex_long'] = 'Использовать слабую проверку email (прим., разрешает "x@y", а не требует "x@y.tld")';
$lang['title_email_from_address'] = '"От куда" для email';
$lang['title_email_encoding'] = 'Кодировка письма';
$lang['title_director_details'] = 'Pulldown-based Emailer Details';
$lang['title_file_name'] = 'Имя файла';
$lang['title_email_subject'] = 'Тема письма';
$lang['title_form_name'] = 'Имя формы';
$lang['title_form_status'] = 'Статус формы';
$lang['title_ready_for_deployment'] = 'Готова к использованию';
$lang['title_not_ready1'] = 'Не готова';
$lang['title_redirect_page'] = 'Страница для перенаправления после отправки формы';
$lang['title_not_ready2'] = 'Пожалуйста, добавьте поле в форму, так чтобы входные данные пользователя обрабатывались. Вы можете';
$lang['title_not_ready_link'] = 'использовать этот ярлык';
$lang['title_form_alias'] = 'Алиас формы';
$lang['title_field_alias_short'] = 'Алиас';
$lang['title_form_fields'] = 'Поля формы';
$lang['title_field_id'] = 'ID поля';
$lang['title_show_fieldaliases'] = 'Показать алиасы полей';
$lang['title_show_fieldaliases_long'] = 'Нажатие на эту кнопку отображает поле алиасов при добавлении или редактировании формы';
$lang['title_field_name'] = 'Имя поля';
$lang['title_field_alias'] = 'Алиас поля';
$lang['title_radiogroup_details'] = 'Radio Button Group Details';
$lang['title_field_type'] = 'Тип поля';
$lang['title_not_ready3'] = 'создать форму обработки поля.';
$lang['title_add_new_form'] = 'Добавить новую форму';
$lang['title_show_version'] = 'Показать версию Form Builder?';
...
$lang['title_add_new_field'] = 'Добавить новое поле';
$lang['title_form_submit_button'] = 'Текст кнопки отправки формы';
$lang['title_button_text'] = 'Текст кнопки';
$lang['title_submit_button_safety'] = 'Add Javascript to Submit Button to prevent multiple submissions?';
$lang['title_submit_button_safety_help'] = 'Добавить скрипт безопасности';
$lang['title_form_next_button'] = 'Текст кнопки перехода на следующую страницу (используется для многостраничных форм)';
$lang['title_form_prev_button'] = 'Текст кнопки перехода на предыдущую страницу  (используется для многостраничных форм)';
$lang['title_field_validation'] = 'Проверка поля';
$lang['title_field_to_validate'] = 'Поле для проверки';
$lang['title_field_css_id'] = 'CSS id для этого поля';
$lang['title_form_css_class'] = 'CSS класс для этой формы';
$lang['title_field_css_class'] = 'CSS класс для этого поля';
$lang['title_form_predisplay_udt'] = 'Пользовательский тег вызова перед отображением формы';
$lang['title_form_predisplay_each_udt'] = 'Тэг пользователя (UDT) вызываемый перед отображением формы (вызывается на каждой странице многостраничной формы)';
$lang['title_form_validate_udt'] = 'Тег пользователя вызываемый во время проверки формы';
$lang['title_form_required_symbol'] = 'Символ для отметки обязательных полей';
$lang['title_field_required'] = 'Обязательно';
$lang['title_field_required_long'] = 'Поле обязательно для заполнения';
$lang['title_hide_label'] = 'Скрыть подпись';
$lang['title_hide_label_long'] = 'Скрыть имя этого поля на форме';
$lang['title_textarea_length'] = 'Максимальная длина содержимого поля (0 или пусто без ограничений)';
$lang['title_text'] = 'Статический текст для показа';
$lang['title_field_regex'] = 'Проверка Regex';
$lang['title_lines_to_show'] = 'Количество строк для показа';
$lang['title_read_only'] = 'Только чтение';
$lang['no_default'] = 'Не по умолчанию';
$lang['redirect_after_approval'] = 'Страница для перенаправления после утверждения';
...
$lang['title_field_required_abbrev'] = 'Обязательно';
$lang['title_hide_errors'] = 'Скрыть ошибки';
$lang['title_form_displaytype'] = 'Тип отображения формы';
$lang['title_hide_errors_long'] = 'Prevent debug / error messages from being seen by users.';
$lang['title_email_template'] = 'Шаблон Email';
$lang['title_maximum_size'] = 'Максимальный размер загружаемого файла (килобайты)';
$lang['title_maximum_size_long'] = 'This limitation is in addition to any limits set by the php or web server configuration';
$lang['title_file_destination'] = 'Каталог для сохранения файлов';
$lang['title_permitted_extensions'] = 'Разрешенные расширения';
$lang['title_permitted_extensions_long'] = 'Введите список расширений через запятую, расширение вводите без точки, (т.е., "jpg,gif,jpeg"). Пробелы игнорируются. Пустое поля подразумевает отсутствие ограничений.';
$lang['title_show_limitations'] = 'Отображать ограничения?';
$lang['title_show_limitations_long'] = 'Отображать ограничения на размера и раширение для поля загрузки файла?';
$lang['title_form_template'] = 'Шаблон используемый для отображения формы';
$lang['title_page_x_of_y'] = 'Страница %s из %s';
$lang['title_no_advanced_options'] = 'Поле не имеет дополнительных параметров.';
$lang['title_form_unspecified'] = 'Текст возвращаемый при неопределенных значениях ';
$lang['title_enable_fastadd_long'] = 'Включить быстрое добавление полей для форм в выпадающем списке?';
$lang['title_enable_fastadd'] = 'Включить быстрое добавление полей в выпадающем списке?';
$lang['title_fastadd'] = 'Быстрое добавление поля';
$lang['title_enable_antispam_long'] = 'Кликните чтобы разрешить отправку не более 10 электронных писем в час для 1 IP адреса.';
$lang['title_enable_antispam'] = 'Включить примитивные анти-спам функции?';
$lang['title_show_fieldids'] = 'Показать ID\'ы полей';
$lang['title_show_fieldids_long'] = 'Clicking this will allow displaying field ids when adding or editing a form';
$lang['title_xml_to_upload'] = 'Загрузить форму из XML файла';
$lang['title_xml_upload_formname'] = 'Использовать это имя для формы';
$lang['title_import_legend'] = 'Форма импорта XML';
$lang['title_xml_upload_formalias'] = 'Использовать этот алиас для формы';
$lang['title_html_email'] = 'Генерировать письмо в HTML?';
$lang['title_link_autopopulate'] = 'Заполнять автоматически?';
...
$lang['title_default_link'] = 'URL ссылки по умолчанию';
$lang['title_default_link_title'] = 'Текст ссылки по умолчанию';
$lang['title_link_to_sitepage'] = 'Ссылка на страницу сайта';
...
$lang['title_use_captcha'] = 'Использовать Captcha для защиты отправки формы?';
...
$lang['title_user_captcha'] = 'Пожалуйста подтвердите что вы человек, введя буквы с изображения.';
$lang['title_user_captcha_error'] = 'Ошибка в тексте для Captcha';
$lang['wrong_captcha'] = 'Captcha некорректна.';
$lang['title_title_user_captcha'] = 'Текст подсказки для Captcha';
$lang['title_dont_submit_unchecked'] = 'Не отправлять значения не отмеченные галочкой';
$lang['title_dont_submit_unchecked_help'] = 'Check this if you only want checked boxes to return values.';
$lang['link_label'] = 'Подпись ссылки';
$lang['link_destination'] = 'URL назначения';
$lang['title_default_set'] = 'По умолчанию отмечено?';
$lang['title_24_hour'] = 'Использовать 24-часовой формат?';
...
$lang['title_encrypt_database_data'] = 'Шифровать данные хранящиеся в базе данных';
...
$lang['title_mle_version'] = 'Запуск в режиме MLE';
...
$lang['choose_crypt'] = 'Библиотека шифрования';
...
$lang['title_crypt_lib'] = 'Библиотека шифрования';
$lang['openssl'] = 'Библиотека OpenSSL';
$lang['mcrypt'] = 'PHP библиотека mcrypt';
...
$lang['title_encryption'] = 'Шифрование';
...
$lang['title_show_to_user'] = 'Отображать пользователей?';
...
$lang['help_leaveempty'] = 'Это поле можно оставить пустым';
$lang['help_variables_for_template'] = 'Переменные для шаблона';
$lang['help_variables_for_computation'] = 'Доступные переменные';
$lang['help_php_variable_name'] = 'Переменные PHP';
$lang['help_submission_date'] = 'Дата отправки';
$lang['help_server_name'] = 'Ваш сервер';
$lang['help_sub_source_ip'] = 'IP адрес персоны использующей форму';
$lang['help_sub_url'] = 'URL страницы содержащей форму';
$lang['help_fb_version'] = 'Версия FormBuilder';
$lang['help_tab'] = 'Символ табуляции';
...
$lang['help_variable_name'] = 'Переменная';
$lang['help_form_field'] = 'Поле представленно';
...
$lang['link_back_to_form'] = '« Назад к форме';
$lang['title_create_sample_template'] = 'Создать простой шаблон';
$lang['title_create_sample_html_template'] = 'Создать простой HTML шаблон';
$lang['title_create_sample_header_template'] = 'Создать простой шаблон заголовка';
$lang['title_create_sample_footer_template'] = 'Создать простой шаблон футера';
$lang['title_create_sample_header'] = 'Создать простой заголовок';
$lang['help_tab_symbol'] = 'символ табуляции';
$lang['title_file_template'] = 'Шаблон для однострочного выходного файла';
$lang['title_file_header'] = 'Шаблон для заголовка выходного файла';
$lang['title_file_footer'] = 'Шаблон для подвала выходного файла';
$lang['title_rtf_file_template'] = 'Шаблон RTF файла для использования';
$lang['title_unique_file_template'] = 'Шаблон для вывода';
$lang['title_file_type'] = 'Выбрать тип файла для использования';
$lang['title_rtf_template_type'] = 'Выбрать тип шаблона RTF';
$lang['title_confirmation_url'] = 'URL to click for form confirmation';
$lang['title_value'] = 'Значение (see Advanced Tab if you use Smarty tags)';
...
$lang['title_submit_date'] = 'Дата отправки';
$lang['title_approval_date'] = 'Дата утверждения (администратора)';
$lang['title_user_approved'] = 'Дата утверждения (отправителя)';
$lang['display_text'] = 'Отображать "Шаблон отправки"';
$lang['redirect_to_page'] = 'Перейти на страницу сайта';
...
$lang['title_destination_page'] = 'Страница назначения';
$lang['title_require_fieldnames'] = 'Обязательны имена полей';
$lang['title_require_fieldnames_long'] = 'Обязательные поля имеют названия?';
$lang['title_unique_fieldnames'] = 'Обязательны уникальные имена полей';
$lang['title_unique_fieldnames_long'] = 'Обязательные поля имеют уникальные названия?';
$lang['title_reorder_form'] = 'Изменить порядок полей';
$lang['title_load_template'] = 'Загрузить шаблон';
$lang['title_add_button_text'] = 'Текст кнопки добавления/создания';
$lang['title_del_button_text'] = 'Текст кнопки удаления';
$lang['title_field_helptext'] = 'Справка-текст, отображаемый с этим полем';
...
$lang['title_string_unspaced'] = 'Строка (без пробелов между полями)?';
$lang['title_compute_value'] = 'Значение для расччета';
$lang['title_compute'] = 'Computed/PHP';
$lang['title_string'] = 'Строка';
$lang['title_numeric'] = 'Число';
$lang['title_inline_form'] = 'Показывать форму встроенной?';
$lang['title_inline_form_help'] = 'Встроенная означает, что последующая форма заменяет тег {cms_module}, невстроенная заменяет тег {content}.';
$lang['title_field_default_value'] = 'Значение поля по умолчанию';
$lang['title_clear_default'] = 'Очистить значение по умолчанию при клике?';
...
$lang['title_field_javascript'] = 'Javascript для поля';
$lang['title_field_javascript_long'] = 'Make this the complete Javascript call, including the event you want to trap, например, onclick="yourfn()"';
...
$lang['title_switch_advanced'] = 'Нужно больше типов полей?';
$lang['title_switch_basic'] = 'Слишком много типов полей?';
$lang['title_switch_advanced_link'] = 'Переключиться на расширенный режим';
$lang['title_switch_basic_link'] = 'Переключить на простой режим';
$lang['title_file_root'] = 'Каталог для сохранения файла в';
...
$lang['title_send_me_a_copy'] = 'Отправить мне копию формы';
...
$lang['title_display_length'] = 'Показать длину';
$lang['title_minimum_length'] = 'Минимальная длина ответа';
$lang['title_hide'] = 'Скрыть поле ввода';
$lang['title_hide_help'] = 'Show symbols rather plain text when user enters password?';
$lang['password_does_not_match'] = 'Пароль не совпадает %s';
$lang['back_top'] = 'Вернуться к главной странице Конструктора форм';
...
$lang['error_CompanyDirectory_module_not_available'] = 'Модуль Company Directory не доступен!';
$lang['option_never'] = 'Никогда';
$lang['option_user_choice'] = 'Дать пользователю выбор (checkbox)';
$lang['option_always'] = 'Всегда';
$lang['option_from'] = '"От кого" email адрес';
$lang['option_reply'] = '"Куда" почтовый адрес';
...
$lang['title_field_logic'] = 'Данные или логика Smarty, которые должны быть отправлены с этим полем';
$lang['title_field_logic_long'] = 'Может быть данные Smarty, javascript или другие данные, которые вы хотите отправить вместе с этим полем,<br />будут проходить через компилятор Smarty, не забудьте использовать тег {literal}{/literal} вместе с <script></script>.';
$lang['title_field_includelabels'] = 'Подключать подписи(метки)';
...
$lang['error_cataloger_module_not_available'] = '<strong>Модуль Cataloger не установлен или не активен.</strong>';
$lang['warning'] = 'ПРЕДУПРЕЖДЕНИЕ!';
$lang['default_template'] = 'Шаблон по умолчанию';
$lang['table_left_template'] = 'Табличный шаблон, подписи слева';
$lang['table_top_template'] = 'Табличный шаблон, подписи сверху';
...
$lang['title_bad_function'] = 'Ошибка при расчете "%s".';
...
$lang['admindesc'] = 'Добавление, изменение и управление работой интерактивных форм';
...
$lang['help_module_interface'] = 'Использование интерфейса модуля';
...
$lang['title_add_tag'] = 'Добавить свой тег';
$lang['date_january'] = 'январь';
$lang['date_february'] = 'февраль';
$lang['date_march'] = 'март';
$lang['date_april'] = 'апрель';
$lang['date_may'] = 'май';
$lang['date_june'] = 'июнь';
$lang['date_july'] = 'июль';
$lang['date_august'] = 'август';
$lang['date_september'] = 'сентябрь';
$lang['date_october'] = 'октябрь';
$lang['date_november'] = 'ноябрь';
$lang['date_december'] = 'декабрь';
$lang['AF'] = 'Афганистан';
$lang['AX'] = 'Аландские острова';
$lang['AL'] = 'Албания';
$lang['DZ'] = 'Алжир';
$lang['AS'] = 'Американское Самоа';
$lang['AD'] = 'Андорра';
$lang['AO'] = 'Ангола';
$lang['AI'] = 'Ангилья';
$lang['AQ'] = 'Антарктида';
$lang['AG'] = 'Антигуа и Барбуда';
$lang['AR'] = 'Аргентина';
$lang['AM'] = 'Армения';
$lang['AW'] = 'Аруба';
$lang['AU'] = 'Австралия';
...
$lang['BZ'] = 'Белиз';
$lang['BJ'] = 'Бенин';
$lang['BM'] = 'Бермудские острова';
$lang['BT'] = 'Бутан';
$lang['BW'] = 'Ботсвана';
$lang['BO'] = 'Боливия';
$lang['BA'] = 'Босния и Герцеговина';
$lang['BV'] = 'Остров Буве';
$lang['BR'] = 'Бразилия';
$lang['IO'] = 'Британская территория в Индийском океане';
$lang['BN'] = 'Бруней-Даруссалам';
$lang['BG'] = 'Болгария';
$lang['BF'] = 'Буркина-Фасо';
$lang['BI'] = 'Бурунди';
$lang['KH'] = 'Камбоджа';
$lang['CM'] = 'Камерун';
$lang['CA'] = 'Канада';
$lang['CV'] = 'Кабо-Верде';
$lang['KY'] = 'Каймановы острова';
$lang['CF'] = 'Центрально-Африканская Республика';
$lang['TD'] = 'Чад';
$lang['CL'] = 'Чили';
$lang['CN'] = 'Китай';
$lang['CX'] = 'Остров Рождества';
$lang['CC'] = 'Кокосовые (Килинг) острова';
$lang['CO'] = 'Колумбия';
$lang['KM'] = 'Коморские острова';
$lang['CG'] = 'Конго';
$lang['CD'] = 'Демократическая Республика Конго';
$lang['CK'] = 'Острова Кука';
$lang['CR'] = 'Коста-Рика';
$lang['CI'] = 'Д\'Ивуар (Берег Слоновой Кости)';
$lang['HR'] = 'Хорватия (Hrvatska)';
$lang['CU'] = 'Куба';
$lang['CY'] = 'Кипр';
$lang['CZ'] = 'Чешская Республика';
$lang['DK'] = 'Дания';
$lang['DJ'] = 'Джибути';
$lang['DM'] = 'Доминика';
$lang['DO'] = 'Доминиканская Республика';
$lang['TP'] = 'Восточный Тимор';
$lang['EC'] = 'Эквадор';
$lang['EG'] = 'Египет';
$lang['SV'] = 'Сальвадор';
$lang['GQ'] = 'Экваториальная Гвинея';
$lang['ER'] = 'Эритрея';
$lang['EE'] = 'Эстония';
$lang['ET'] = 'Эфиопия';
$lang['FK'] = 'Фолклендские (Мальвинские) острова';
$lang['FO'] = 'Фарерские острова';
$lang['FJ'] = 'Фиджи';
$lang['FI'] = 'Финляндия';
$lang['FR'] = 'Франция';
$lang['FX'] = 'Франция, митрополит';
$lang['GF'] = 'Гернси';
$lang['PF'] = 'Французская Полинезия';
$lang['TF'] = 'Французские южные территории';
$lang['MK'] = 'F.Y.R.O.M. (Македония)';
$lang['GA'] = 'Габон';
$lang['GM'] = 'Гамбия';
$lang['GE'] = 'Грузия';
$lang['DE'] = 'Германия';
...
$lang['GT'] = 'Гватемала';
$lang['GN'] = 'Гвинея';
$lang['GW'] = 'Гвинея-Бисау';
$lang['GY'] = 'Гайана';
$lang['HT'] = 'Гаити';
$lang['HM'] = 'Херд и Макдональд';
$lang['HN'] = 'Гондурас';
$lang['HK'] = 'Гонконг';
$lang['HU'] = 'Венгрия';
$lang['IS'] = 'Исландия';
...
$lang['NP'] = 'Непал';
$lang['NL'] = 'Нидерланды';
$lang['AN'] = 'Нидерландские Антильские острова';
$lang['NT'] = 'Нейтральная зона';
$lang['NC'] = 'Новая Каледония';
$lang['NZ'] = 'Новая Зеландия (Аотеароа)';
$lang['NI'] = 'Никарагуа';
$lang['NE'] = 'Нигер';
$lang['NG'] = 'Нигерия';
$lang['NU'] = 'Ниуэ';
$lang['NF'] = 'Остров Норфолк';
$lang['MP'] = 'Северные Марианские острова';
$lang['NO'] = 'Норвегия';
$lang['OM'] = 'Оман';
$lang['PK'] = 'Пакистан';
$lang['PW'] = 'Палау';
$lang['PS'] = 'Палестинская территория';
$lang['PA'] = 'Панама';
$lang['PG'] = 'Папуа-Новая Гвинея';
$lang['PY'] = 'Парагвай';
$lang['PE'] = 'Перу';
$lang['PH'] = 'Филиппины';
$lang['PN'] = 'Питкэрн';
...
$lang['PR'] = 'Пуэрто Рико';
$lang['QA'] = 'Катар';
$lang['RE'] = 'Воссоединение';
$lang['RO'] = 'Румыния';
$lang['RU'] = 'Россияская Федерация';
$lang['RW'] = 'Руанда';
$lang['GS'] = 'S. Georgia and S. Sandwich Isls. ';
$lang['KN'] = 'Сент-Китс и Невис';
$lang['LC'] = 'Сент-Люсия';
$lang['VC'] = 'Saint Vincent & the Grenadines';
$lang['WS'] = 'Самоа';
$lang['SM'] = 'Сан - Марино';
$lang['ST'] = 'Сан-Томе и Принсипи';
$lang['SA'] = 'Саудовская Аравия';
$lang['SN'] = 'Сенегал';
$lang['SC'] = 'Сейшельские острова';
$lang['SL'] = 'Сьерра-Леоне';
$lang['SG'] = 'Сингапур';
$lang['SI'] = 'Словения';
$lang['SK'] = 'Словацкая Республика';
$lang['SB'] = 'Соломоновы Острова';
$lang['SO'] = 'Сомали';
$lang['ZA'] = 'Южная Африка';
$lang['ES'] = 'Испания';
$lang['LK'] = 'Шри-Ланка';
$lang['SH'] = 'Св. Елены';
$lang['PM'] = 'Сен-Пьер и Микелон';
$lang['SD'] = 'Судан';
$lang['SR'] = 'Суринам';
...
$lang['TK'] = 'Токелау';
$lang['TO'] = 'Тонга';
$lang['TT'] = 'Тринидад и Тобаго';
$lang['TN'] = 'Тунис';
$lang['TR'] = 'Турция';
$lang['TM'] = 'Туркменистан';
$lang['TC'] = 'Острова Теркс и Кайкос';
$lang['TV'] = 'Тувалу';
$lang['UG'] = 'Уганда';
$lang['UA'] = 'Украина';
$lang['AE'] = 'Объединенные Арабские Эмираты';
$lang['UK'] = 'Соединенное Королевство';
$lang['US'] = 'Соединенные Штаты';
$lang['UM'] = 'США Внешние малые острова';
$lang['UY'] = 'Уругвай';
$lang['UZ'] = 'Узбекистан';
$lang['VU'] = 'Вануату';
$lang['VA'] = 'Государство-город Ватикан (Святейший Престол)';
$lang['VE'] = 'Венесуэла';
$lang['VN'] = 'Вьетнам';
$lang['VG'] = 'Виргинские острова (Британские)';
$lang['VI'] = 'Виргинские острова (США)';
$lang['WF'] = 'Острова Уоллис и Футуна';
$lang['EH'] = 'Западная Сахара';
$lang['YE'] = 'Йемен';
$lang['YU'] = 'Югославия';
$lang['ZM'] = 'Замбия';
$lang['ZW'] = 'Зимбабве';
...
$lang['nouploads_error'] = 'Не могу найти модуль отправки';
...
$lang['unchecked_by_default'] = 'По умолчанию: не отмечено';
$lang['checked_by_default'] = 'По умолчанию: отмечено';
$lang['email_default_template'] = 'FormBuilder Submission';
$lang['email_template_not_set'] = '<br/>Шаблон Email еще не готов!';
$lang['missing_cms_mailer'] = 'FormBuilder: Не удается обнаружить необходимый модуль CMSMailer!';
...
$lang['formbuilder_params_form_name'] = 'Имя формы';
$lang['formbuilder_params_form_id'] = 'ID формы для внутренних операций';
$lang['formbuilder_params_general'] = 'Общие параметры для внутренних операций';
$lang['template_variable_help'] = '<h3>Переменные шаблона формы</h3>
...
';
$lang['post_install'] = 'FormBuilder установлен. Пожалуйста, ознакомьтесь с  документацией на странице справки  модуля.';
...
<p>Copyright © 2009, Samuel Goldstein <a href="mailto:sjg@cmsmodules.com"><sjg@cmsmodules.com></a>. All Rights Are Reserved.</p>
<p>This module has been released under the <a href="http://www.gnu.org/licenses/licenses.html#GPL">GNU Public License</a>. You must agree to this license before using the module.</p>';
$lang['utma'] = '156861353.750739657.1301355191.1306223606.1306231165.31';
...
$lang['utmc'] = '156861353';
$lang['utmb'] = '156861353.1.10.1306231165';
?>