...
$lang['field_type_PasswordField'] = 'L&ouml;senord';
$lang['field_type_PasswordAgainField'] = 'L&ouml;senord igen';
...
$lang['field_type_YearPullDownField'] = '&Aring;r Rullgardinsmeny';
$lang['field_type_MultiselectField'] = 'Multiv&auml;ljare';
$lang['field_type_StatePickerField'] = 'V&auml;ljare f&ouml;r amerikansk stat';
$lang['field_type_ProvincePickerField'] = 'Kanadensisk Provins V&auml;ljare';
...
$lang['field_type_UniqueIntegerField'] = '- Unikt heltal (Serie)';
$lang['field_type_UserTagField'] = '-Anv&auml;ndar Definierat Tag Anrop';
$lang['field_type_CompanyDirectoryField'] = 'F&ouml;retagskatalog f&auml;lt';
$lang['field_type_ModuleInterfaceField'] = '-Modulgr&auml;nssnitts f&auml;lt';
...
$lang['please_login'] = 'V&auml;nligen logga in f&ouml;r att anv&auml;nda formul&auml;ret';
...
$lang['please_enter_at_least'] = 'Var v&auml;nlig ange ett v&auml;rde som &auml;r minst %s tecken';
...
$lang['value_set'] = 'V&auml;rdeupps&auml;ttning: %s';
...
<br/>';
$lang['help_name_regex'] = 'Ett vanligt uttryck f&ouml;r att till&aring;ta filtrering av kataloger genom namn';
$lang['help_field_height'] = 'H&ouml;jden p&aring; flervalsf&auml;ltet';
...
$lang['title_show_fieldaliases_long'] = 'Om du klickar h&auml;r kommer f&auml;ltalias att visas n&auml;r du l&auml;gger till eller redigerar ett formul&auml;r';
...
$lang['title_button_text'] = 'Knapp text';
...
$lang['title_field_css_id'] = 'CSS id f&ouml;r detta f&auml;lt';
...
$lang['title_form_predisplay_udt'] = 'Anv&auml;ndardefinierad tag att l&auml;sa in f&ouml;re formul&auml;ret visas';
$lang['title_form_predisplay_each_udt'] = 'Anv&auml;ndardefinierad tag att anropa innan formul&auml;r visas (anropad p&aring; varje sida som ing&aring;r i ett formul&auml;r med flera sidor)';
$lang['title_form_validate_udt'] = 'Anv&auml;ndardefinierad tag att anropa under formul&auml;r validation';
...
$lang['title_dont_submit_unchecked_help'] = 'Klicka h&auml;r om du bara vill ha f&ouml;rkryssade rutors v&auml;rden.';
$lang['link_label'] = 'L&auml;nktetikett';
$lang['link_destination'] = 'URL';
$lang['title_default_set'] = 'Ikryssad som standard?';
$lang['title_24_hour'] = 'Anv&auml;nd 24-timmars tidsangivelse?';
$lang['title_before_noon'] = 'EM';
$lang['title_after_noon'] = 'FM';
...
$lang['title_restrict_to_group'] = 'Begr&auml;nsa anv&auml;ndarlistan till anv&auml;ndare i viss grupp';
$lang['title_encrypt_database_data'] = 'Kryptera lagrad data i databasen';
$lang['title_crypt_cert'] = 'Certifikat f&ouml;r kryptering av data';
...
$lang['title_private_key'] = 'Privat nyckel f&ouml;r kryptering av data';
...
$lang['title_encryption_functions'] = 'Lagringskryptering otillg&auml;nglig';
$lang['title_install_crypto'] = 'Var v&auml;nlig installera OpenSSL modulen eller mcrypt st&ouml;d om du vill m&ouml;jligg&ouml;ra databaskryptering';
$lang['title_install_curl'] = 'Kontrollera att du har st&ouml;d f&ouml;r CURL aktiverat i din PHP installation. Se http://www.php.net/manual/en/book.curl.php';
$lang['title_mle_version'] = 'K&ouml;r i MLE l&auml;ge';
...
$lang['choose_crypt'] = 'Krypterings bibliotek';
...
$lang['title_crypt_lib'] = 'Krypterings bibliotek';
$lang['openssl'] = 'OpenSSL Library';
$lang['mcrypt'] = 'PHP mcrypt Library';
$lang['title_feu_binding'] = 'Frontend User binding';
$lang['title_install_feu'] = 'Var v&auml;nlig installera Frontend User modulen f&ouml;r att koppla ett formul&auml;r och dess data till en specifik anv&auml;ndare';
...
$lang['restricted_to_group'] = 'Endast i grupp %s';
$lang['title_show_to_user'] = 'Visa f&ouml;r anv&auml;ndare?';
...
$lang['title_create_sample_header_template'] = 'Skapa Provmall f&ouml;r Headern';
...
$lang['title_start_year'] = 'Start p&aring; &aring;romf&aring;ng';
$lang['title_end_year'] = 'Slut p&aring; &aring;romf&aring;ng';
$lang['title_default_year'] = 'Standard &Aring;r';
$lang['title_default_year_help'] = '(S&auml;tt till -1 f&ouml;r att standard&aring;r ska vara nuvarande &aring;r)';
$lang['title_submit_action'] = 'Efter att formul&auml;ret l&auml;mnats in';
$lang['title_submit_response'] = 'Response to display';
$lang['title_submit_date'] = 'Date Submitted';
$lang['title_approval_date'] = 'Datum Godk&auml;nd (av admin)';
$lang['title_user_approved'] = 'Date Approved (by submitter)';
$lang['display_text'] = 'Display &quot;Submission Template&quot;';
$lang['redirect_to_page'] = 'Skicka till sida';
...
$lang['title_require_fieldnames'] = 'Kr&auml;ver f&auml;ltnamn';
$lang['title_require_fieldnames_long'] = 'Kr&auml;v att f&auml;lt har ett namn?';
$lang['title_unique_fieldnames'] = 'Kr&auml;v unika f&auml;ltnamn';
$lang['title_unique_fieldnames_long'] = 'Kr&auml;v att f&auml;lt har unika namn?';
$lang['title_reorder_form'] = 'Omgruppera f&auml;lt';
$lang['title_load_template'] = 'Ladda mall';
$lang['title_add_button_text'] = 'L&auml;tt';
$lang['title_del_button_text'] = 'Radera knapptext';
$lang['title_field_helptext'] = 'Hj&auml;lp-text att visas med det h&auml;r f&auml;ltet';
...
$lang['title_field_default_value'] = 'Standardv&auml;rde f&ouml;r f&auml;lt';
...
$lang['title_field_javascript'] = 'Javascript f&ouml;r f&auml;lt';
...
$lang['email_from_addr_help'] = 'V&auml;lj inte bara en slumpartad adress h&auml;r -- m&aring;nga ISPs kommer <br /> inte att leverera mailet om du anv&auml;nder en annan dom&auml;n &auml;n ditt verkliga <br /> host (d.v.s., anv&auml;nd n&aring;got som namn@%s)';
$lang['title_switch_advanced'] = 'Beh&ouml;ver du fler f&auml;lttyper? ';
$lang['title_switch_basic'] = 'F&ouml;r m&aring;nga f&ouml;rvirrande f&auml;lttyper?';
...
$lang['title_file_root'] = 'Folder f&ouml;r att spara filer i';
...
$lang['title_send_me_a_copy'] = 'Skicka mig en kopia av formul&auml;ret';
...
$lang['password_does_not_match'] = 'L&ouml;senord matchar inte %s';
...
$lang['title_add_tag'] = 'L&auml;gg till din tag';
...
$lang['upload_attach_error'] = 'Uppladdnings/Bifogningsfel f&ouml;r fil %s (tmp_name: %s, av typen %s)';
$lang['submission_error_file_lock'] = 'Ett fel har uppst&aring;tt! Kunde inte ordna l&aring;sning p&aring; filen.';
$lang['unchecked_by_default'] = 'Standard: omarkerad';
$lang['checked_by_default'] = 'Standard: markerad';
$lang['email_default_template'] = 'FormBuilder Submission';
$lang['email_template_not_set'] = '<br/>Ingen epostmall &auml;r tillsatt!';
