...
$lang['field_type_'] = 'Typ poľa nebol definovan&yacute;';
$lang['field_type_CatalogerItemsField'] = 'Vybrať jeden alebo viacero položiek katal&oacute;gu (cataloger)';
$lang['field_type_FieldsetEnd'] = 'Koniec pre značku Fieldset';
$lang['field_type_FieldsetStart'] = 'Začiatok pre značku Fieldset ';
$lang['field_type_TextField'] = 'Textov&eacute; pole';
$lang['field_type_TextFieldExpandable'] = 'Textov&eacute; pole (viacn&aacute;sobn&eacute;)';
$lang['field_type_TextAreaField'] = 'Textov&eacute; oblasť';
$lang['field_type_CheckboxField'] = 'Za&scaron;krt&aacute;vacie pole';
$lang['field_type_CheckboxGroupField'] = 'Skupina za&scaron;krt&aacute;va&iacute;ch pol&iacute;čok';
$lang['field_type_PulldownField'] = 'V&yacute;berov&eacute; pole';
$lang['field_type_MultiselectField'] = 'Viacv&yacute;berov&eacute; pole';
$lang['field_type_StatePickerField'] = 'V&yacute;berov&eacute; pole pre &scaron;t&aacute;ty';
$lang['field_type_ProvincePickerField'] = 'V&yacute;berov&eacute; pole pre provincie v Kanade';
$lang['field_type_CountryPickerField'] = 'V&yacute;berov&eacute; pole pre USA &scaron;t&aacute;ty';
$lang['field_type_DatePickerField'] = 'V&yacute;berov&eacute; pole pre d&aacute;tum';
$lang['field_type_TimePickerField'] = 'V&yacute;berov&eacute; pole pre čas';
$lang['field_type_RadioGroupField'] = 'Skupina radio poličok';
$lang['field_type_DispositionDirector'] = '*Zasielanie na e-maily na z&aacute;klade v&yacute;berov&eacute;ho poľa';
$lang['field_type_DispositionFileDirector'] = '*Ukladanie do s&uacute;bora na z&aacute;klade v&yacute;berov&eacute;ho poľa';
$lang['field_type_DispositionMultiselectFileDirector'] = '*Ukladanie do s&uacute;borov na z&aacute;klade viacn&aacute;sobn&eacute;ho v&yacute;berov&eacute;ho poľa';
$lang['field_type_DispositionPageRedirector'] = '*Str&aacute;nka pre presmerovania na z&aacute;klade v&yacute;berov&eacute;ho poľa';
$lang['field_type_DispositionEmail'] = '*Zasielanie na vybran&eacute; e-mailov&eacute; adresy';
$lang['field_type_DispositionEmailConfirmation'] = '*Validate-via-Email Address';
$lang['field_type_DispositionFromEmailAddressField'] = '*Pole  &quot;z e-mailu&quot; pre odpoved, a zaslanie k&oacute;pie už&iacute;vateľovi';
$lang['field_type_DispositionFile'] = '*Uložiť formul&aacute;r do s&uacute;bora';
$lang['field_type_DispositionDatabase'] = '*Uložiť formul&aacute;r do DB';
$lang['field_type_DispositionFormBrowser'] = '*Uložiť formul&aacute;r pre modul prehliadača formul&aacute;rov v&eacute;rzie .3';
$lang['field_type_DispositionUserTag'] = '*Zavolať už&iacute;vateľsk&yacute; tag po dokončen&iacute;';
$lang['field_type_DispositionDeliverToEmailAddressField'] = '*Pole pre e-mail, na ktor&yacute; bude z&aacute;roveň zaslan&yacute; e-mail';
$lang['field_type_DispositionEmailSiteAdmin'] = '*E-mail pre administr&aacute;tora CMS';
$lang['field_type_PageBreakField'] = '-zalomenie';
$lang['field_type_FileUploadField'] = 'Nahratie s&uacute;bora';
$lang['field_type_FromEmailAddressField'] = 'Email &quot;From Address&quot; Field';
$lang['field_type_FromEmailAddressAgainField'] = 'Pole  &quot;z e-mailu&quot; pre opakovan&eacute; zadanie ';
...
$lang['field_type_LinkField'] = 'Odkaz vložen&yacute; už&iacute;vateľom';
$lang['field_type_HiddenField'] = '-Skryt&eacute; pole';
$lang['field_type_ComputedField'] = '-Porovn&aacute;vanie';
$lang['field_type_UniqueIntegerField'] = '-Unik&aacute;tny reťazec';
$lang['validation_none'] = 'Bez kontroly';
$lang['validation_numeric'] = 'Č&iacute;slo';
$lang['validation_integer'] = 'Celoč&iacute;slen&aacute; hodnota';
$lang['validation_email_address'] = 'E-mailov&aacute; adresa';
$lang['validation_usphone'] = 'Telef&oacute;nne č&iacute;sle (pre USA)';
$lang['validation_must_check'] = 'Mus&iacute; byť  zadan&eacute;';
$lang['validation_regex_match'] = 'Regul&aacute;rny v&yacute;raz';
$lang['validation_regex_nomatch'] = 'Zhoda  s regul&aacute;rnym v&yacute;razom';
$lang['required_field_missing'] = 'Nebola vožena požadovan&aacute; hodnota';
$lang['please_enter_a_value'] = 'Pros&iacute;m, vložte hodnotu pre  &quot;%s&quot;';
$lang['please_enter_a_number'] = 'Pros&iacute;m, vložte č&iacute;seln&uacute; hodnotu pre  &quot;%s&quot;';
$lang['please_enter_valid'] = 'Pros&iacute;m, vložte spr&aacute;vnu hodnotu pre &quot;%s&quot;';
$lang['please_enter_an_integer'] = 'Pros&iacute;m, vložte celoč&iacute;seln&uacute; hodnotu pre  &quot;%s&quot;';
$lang['please_enter_an_email'] = 'Pros&iacute;m, vložte spr&aacute;vny tvar e-mailovej adresy pre  &quot;%s&quot;';
$lang['email_address_does_not_match'] = 'Nebol zadan&yacute; obsah pre e-mailov&uacute; adresu &quot;%s&quot;';
$lang['please_enter_a_phone'] = 'Pros&iacute;m, vložte spr&aacute;vny tvar pre telef&oacute;nne č&iacute;slo &quot;%s&quot;';
$lang['not_valid_email'] = '&quot;%s&quot; nie je spr&aacute;vny tvar e-mailovej adresy';
$lang['please_enter_no_longer'] = 'Pros&iacute;m, vložte obsah krat&scaron;&iacute; ako %s znakov';
$lang['title_list_delimiter'] = 'Znak sl&uacute;žiaci ako separ&aacute;tor pri viacer&yacute;ch hodnot&aacute;ch';
...
$lang['field_order_updated'] = 'Pole pre triedenie aktualizovan&eacute;';
$lang['form_deleted'] = 'Formul&aacute;r odstr&aacute;nen&yacute;';
$lang['field_deleted'] = 'Pole odstr&aacute;nen&eacute;';
$lang['configuration_updated'] = 'Nastavenia aktualizovan&eacute;';
$lang['you_must_check'] = 'Musite vybrať &quot;%s&quot; pre  pokračovanie';
$lang['must_specify_one_destination'] = 'Mus&iacute;te zadať aspoň jednu cieľov&uacute; adresu';
$lang['are_you_sure_delete_form'] = 'Naozaj chcete odstr&aacute;niť formul&aacute;r %s?';
$lang['are_you_sure_delete_field'] = 'Naozaj chcete odstr&aacute;niť pole %s?';
$lang['notice_select_type'] = 'Roz&scaron;&iacute;ren&eacute; vlasnosti nie s&uacute; dostupn&eacute; pokiaľ nebude zadan&yacute; typ poľa.';
$lang['field_name_in_use'] = 'N&aacute;zov poľa &quot;%s&quot; už existuje. Pros&iacute;m použite unik&aacute;tny n&aacute;zov, alebo v nastaveniach deaktivujte voľbu pre unik&aacute;tn&eacute; n&aacute;zvy pol&iacute;.';
$lang['field_no_name'] = 'Pole mus&iacute; mať n&aacute;zov';
...
$lang['order'] = 'Poradie';
$lang['unspecified'] = 'nezadan&eacute;';
$lang['added'] = 'pridan&eacute;';
$lang['updated'] = 'aktualizovan&eacute;';
$lang['sort_options'] = 'Trieť hodnoty na v&yacute;stupe';
...
$lang['file_count'] = '%s  povolen&eacute; s&uacute;bory';
...
$lang['illegal_file_type'] = 'Typ s&uacute;boru asi nem&ocirc;že byť nahran&yacute; na server. Pros&iacute;m skontrolujte či je tento typ povolen&yacute;';
$lang['upload'] = 'Nahrať';
...
$lang['thanks'] = 'Vďaka! V&aacute;&scaron; formul&aacute;r bol odoslan&yacute;';
$lang['edit'] = 'Upraviť';
...
$lang['tab_main'] = 'Hlavn&eacute;';
$lang['tab_symbol'] = 'Nastavenia formul&aacute;ra';
$lang['tab_submit'] = 'Odoslanie formul&aacute;ra';
$lang['tab_captcha'] = 'Nastavenia pre Captcha';
$lang['tab_advanced'] = 'Roz&scaron;&iacute;ren&eacute; nastavenia';
$lang['tab_templatelayout'] = '&Scaron;abl&oacute;na';
$lang['tab_submissiontemplate'] = '&Scaron;abl&oacute;na po odoslan&iacute;';
$lang['canuse_smarty'] = '<em>Smarty premenn&eacute; su povolen&eacute; v tomto poli.</em>';
$lang['add_options'] = 'Pridať viac možnost&iacute;';
$lang['delete_options'] = 'Odstr&aacute;niť vyznačen&eacute;';
$lang['add_checkboxes'] = 'Pridať za&scaron;krt&aacute;vacie pole';
$lang['delete_checkboxes'] = 'Odstr&aacute;niť vybran&eacute;';
$lang['add_address'] = 'Pridať e-mailov&uacute; adresu';
$lang['delete_address'] = 'Odstr&aacute;niť vybran&eacute;';
$lang['add_destination'] = 'Pridať cieľ';
$lang['delete_destination'] = 'odstr&aacute;niť vybran&eacute;';
...
<br/>';
$lang['help_name_regex'] = 'Regul&aacute;rny v&yacute;raž povol&iacute; filtrovať katal&oacute;g (cataloger) pomocou n&aacute;zvu';
$lang['help_field_height'] = 'V&yacute;&scaron;ka viacn&aacute;sobn&eacute;ho v&yacute;berov&eacute;ho poľa';
$lang['title_name_regex'] = 'Regul&aacute;rny v&yacute;raz pre položku katal&oacute;gu (Cataloger)';
$lang['title_field_height'] = 'V&yacute;&scaron;ka poľa';
$lang['title_file_path'] = 'Cieľov&aacute; adresa pre s&uacute;bory na v&yacute;stupe';
...
$lang['title_uploadmodule_summary'] = 'Odoslan&eacute; pomocou modulu Formul&aacute;ra';
...
$lang['title_destination_address'] = 'Cieľov&aacute; e-mailov&aacute; adresa';
$lang['title_destination_filename'] = 'Cieľov&yacute; n&aacute;zov s&uacute;boru';
...
$lang['title_director_details'] = 'V&yacute;berov&eacute; pole pre zaslanie detailu formul&aacute;ra';
...
$lang['title_form_css_class'] = 'CSS trieda pre tento formul&aacute;r';
...
$lang['title_form_required_symbol'] = 'Znak pre označenie povinn&yacute;ch pol&iacute;';
$lang['title_field_required'] = 'Povinn&eacute;';
...
$lang['title_field_regex'] = 'Regul&aacute;rny v&yacute;raz pre kontrolu';
$lang['title_lines_to_show'] = 'Počet zobrazen&yacute;ch riadkov';
$lang['no_default'] = 'Bez prednastavenia';
$lang['redirect_after_approval'] = 'Str&aacute;nka pre presmerovanie po schv&aacute;len&iacute;';
...
$lang['title_form_displaytype'] = 'Typ pre zobrazenie formul&aacute;ra';
$lang['title_hide_errors_long'] = 'Prevent debug / error messages from being seen by users.';
$lang['title_email_template'] = '&Scaron;abl&oacute;na e-malu';
$lang['title_maximum_size'] = 'Maxim&aacute;lna veľkosť nahr&aacute;van&eacute;ho s&uacute;boru (kilobytes)';
$lang['title_maximum_size_long'] = 'This limitation is in addition to any limits set by the php or web server configuration';
$lang['title_permitted_extensions'] = 'Povolen&eacute; roz&scaron;&iacute;renia';
...
$lang['title_form_template'] = 'Sabl&oacute;na pre zobrazenie formul&aacute;ra';
$lang['title_page_x_of_y'] = 'Strana %s z %s';
$lang['title_no_advanced_options'] = 'Pole nem&aacute; rož&iacute;ren&eacute; nastavenia';
...
$lang['title_fastadd'] = 'R&yacute;chle prid&aacute;vanie pol&iacute;';
$lang['title_enable_antispam_long'] = 'Clicking this will only allow 10 emails to be triggered from a given IP address (per hour).';
$lang['title_enable_antispam'] = 'Zapn&uacute;ť jednotuchy anti-spam filter?';
$lang['title_show_fieldids'] = 'Uk&aacute;zať IDčka pol&iacute;';
$lang['title_show_fieldids_long'] = 'Clicking this will allow displaying field ids when adding or editing a form';
$lang['title_xml_to_upload'] = 'Nahrať formul&aacute;r z XML s&uacute;boru';
$lang['title_xml_upload_formname'] = 'Použiť tento n&aacute;zov formul&aacute;ra';
$lang['title_import_legend'] = 'XML import formul&aacute;ra';
$lang['title_xml_upload_formalias'] = 'Použiť tento alias formul&aacute;ra';
...
$lang['title_default_link'] = 'Prednastaven&aacute; URL';
$lang['title_default_link_title'] = 'Prednastaven&yacute; odkaz textu';
$lang['title_link_to_sitepage'] = 'Odkaz na str&aacute;nku';
...
$lang['title_use_captcha_help'] = 'Pozrieť inform&aacute;cie o <a href="http://www.wikipedia.org/wiki/Captcha" target="_new">&quot;Captcha&quot;</a>.';
...
$lang['wrong_captcha'] = 'Captcha nebola op&iacute;san&aacute; spr&aacute;vne';
...
$lang['title_24_hour'] = 'Použiť 24hodinov&yacute; čas?';
$lang['title_before_noon'] = 'AM';
$lang['title_after_noon'] = 'PM';
$lang['title_smarty_eval'] = 'Process smarty tags within field?';
$lang['title_textarea_rows'] = 'Riadky (poznamka:m&ocirc;žete meniť aj pomocou CSS)';
$lang['title_textarea_cols'] = 'Stĺpce  (pozn&aacute;mka: m&ocirc;žete meniť aj pomocou CSS)';
...
$lang['title_show_to_user'] = 'Zobraziť už&iacute;vateľovi?';
$lang['help_leaveempty'] = 'Toto pole m&ocirc;že byť pr&aacute;zdne';
$lang['help_variables_for_template'] = 'Premenne pre &scaron;abl&oacute;nu';
$lang['help_variables_for_computation'] = 'Dostupn&eacute; premenn&eacute;';
$lang['help_php_variable_name'] = 'PHP premenn&eacute;';
$lang['help_submission_date'] = 'D&aacute;tum odoslania';
$lang['help_server_name'] = 'V&aacute;&scaron; server';
$lang['help_sub_source_ip'] = 'IP adresa odosielateľa';
$lang['help_sub_url'] = 'URL str&aacute;nky obsahuj&uacute;cej formul&aacute;r';
$lang['help_fb_version'] = 'Verzia modulu formul&aacute;ra';
$lang['help_tab'] = 'Znakov&aacute; sada';
...
$lang['help_variable_name'] = 'Premenn&aacute;';
$lang['help_form_field'] = 'Field Represented';
$lang['link_back_to_form'] = '&laquo; Back to Form';
$lang['title_create_sample_template'] = 'Vytvoriť uk&aacute;žku &scaron;abl&oacute;ny';
$lang['title_create_sample_html_template'] = 'Vytvoriť uk&aacute;žku HTML &scaron;abl&oacute;ny';
$lang['title_create_sample_header_template'] = 'Vytvoriť uk&aacute;žku hlavičky &scaron;abl&oacute;ny';
$lang['title_create_sample_header'] = 'Vytvoriť uk&aacute;žku hlavičky';
$lang['help_tab_symbol'] = 'znakov&aacute; sada';
...
$lang['title_default_year'] = 'Prednastaven&yacute; rok';
...
$lang['display_text'] = 'Zobraziť &quot;&scaron;abl&oacute;nu po odoslan&iacute;&quot;';
$lang['redirect_to_page'] = 'Presmerovať na str&aacute;nku';
...
$lang['title_destination_page'] = 'Cieľov&aacute; str&aacute;nka';
$lang['title_require_fieldnames'] = 'Povinn&eacute; n&aacute;zvy pol&iacute;';
$lang['title_require_fieldnames_long'] = 'Vyžadovať zad&aacute;vanie n&aacute;zvov pre polia';
$lang['title_unique_fieldnames'] = 'Vyžadovať unik&aacute;tne n&aacute;zvy pre polia';
$lang['title_unique_fieldnames_long'] = 'Vyžiadovať unik&aacute;tne n&aacute;zvy';
$lang['title_reorder_form'] = 'Preh&aacute;dzať polia';
$lang['title_load_template'] = 'Nahrať &scaron;abl&oacute;nu';
$lang['title_add_button_text'] = 'Pridať text tlač&iacute;tka';
$lang['title_del_button_text'] = 'odstr&aacute;niť text trač&iacute;tka';
...
$lang['title_numeric'] = 'Č&iacute;slo';
...
$lang['title_field_default_value'] = 'Prednastaven&aacute; hodnota prepole';
$lang['title_clear_default'] = 'Vyčistiť po kliknut&iacute;?';
...
$lang['title_submit_javascript'] = 'Javascript po odoslan&iacute; forml&aacute;ra';
...
$lang['title_switch_advanced'] = 'Viac typov pol&iacute;? ';
$lang['title_switch_basic'] = 'Too many confusing field types? ';
$lang['title_switch_advanced_link'] = 'Prepn&uacute;ť do rozč&iacute;ren&eacute;ho m&oacute;du';
$lang['title_switch_basic_link'] = 'Prepn&uacute;ť do jednoduch&eacute;ho m&oacute;du';
...
$lang['default_template'] = 'Prednastaven&aacute; &scaron;abl&oacute;na';
$lang['table_left_template'] = 'Tabuľka, popisok k poli vľavo';
$lang['table_top_template'] = 'Tabuľka, popisok k poľu nad';
$lang['form_template_name'] = '&Scaron;abl&oacute;na z %s';
...
$lang['formbuilder_params_form_name'] = 'N&aacute;zov formul&aacute;ra';
